...
#ritvix23 did some changes in mutate_rate()
...
class FloatAttribute(BaseAttribute):
	...
	#ritvix23 changed the mutation operation to best suit the evolution for the flappy bird game.
        r1 = random()
        if r1 < mutate_rate:
            r2 = random()
            if r2<replace_rate:
                ...
                return self.clamp((value*uniform(0.5, 2) + uniform(-1,1))*choice([-1,1]), config)
